...
* [iOS 11 beta font for iOS 10+](https://raw.github.com/PoomSmart/EmojiLibrary/master/Font-11b1/AppleColorEmoji@2x.ttc)
* [iOS 11 beta font for iOS <= 9.3](https://raw.github.com/PoomSmart/EmojiLibrary/master/Font-11b1/AppleColorEmoji@2x.ttf)
...
* For iOS 8.2 - 10.x users, place downloaded files at /System/Library/Fonts/Core on your device

Important Notes
=============

* If you choose "iOS 11 beta font for iOS <= 9.3" and you are using non-Retina device, rename the font name from AppleColorEmoji@2x.ttf to <b>AppleColorEmoji.ttf (iOS != 8.2)</b>, or from AppleColorEmoji@2x.ttf to <b>AppleColorEmoji_1x.ttf</b> otherwise.
* If you choose the "iOS 11 beta font for iOS <= 9.3" font and you are at iOS 8.3+, make sure you don't have the original CCF file in the same directory. You can either move this CCF to somewhere else or rename it to something else.
